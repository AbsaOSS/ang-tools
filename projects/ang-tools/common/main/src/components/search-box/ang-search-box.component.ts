...
import { BaseComponent } from '@absaoss/ang-tools/utils'
...
@Component({
    selector: 'ang-search-box',
    templateUrl: './ang-search-box.component.html',
})
export class AngSearchBoxComponent extends BaseComponent {
