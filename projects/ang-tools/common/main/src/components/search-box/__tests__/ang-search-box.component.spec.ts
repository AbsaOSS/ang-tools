 ...
 */
import { AngTranslateTestingModule } from '@absaoss/ang-tools/utils/translate'
...
describe('AngSearchComponent', () => {
    let component: AngSearchBoxComponent
    let fixture: ComponentFixture<AngSearchBoxComponent>
    ...
    beforeEach(waitForAsync(() => {
        return TestBed.configureTestingModule({
            imports: [
                ...
                // TranslateModule,
                AngTranslateTestingModule,
                MatAutocompleteModule,
            ],
            declarations: [AngSearchBoxComponent],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(AngSearchBoxComponent)
        component = fixture.componentInstance
        fixture.detectChanges()
    })

    function extractInputNativeElm(componentFixture: ComponentFixture<AngSearchBoxComponent>): HTMLInputElement {
        return componentFixture.debugElement.query(By.css('.ang-search-box__input')).nativeElement
    }
